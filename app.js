...
title, director, and yearReleased.Your task is to iterate over
this array using the forEach method and log a message for each 
movie in the format: "Title (Year) directed by Director". -- >
...
// function callDetails(title, director, yearReleased) {
//     console.log(`${movie.title} (${movie.yearReleased}) directed by ${movie.director}.`)
// };

// movies.forEach(callDetails);
